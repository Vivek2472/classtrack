        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p class="font-body-md" style="color: var(--color-on-surface-variant); font-size: 0.875rem;">
              Welcome back, <strong>${state.profile.name || 'Student'}</strong>
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div class="lg:col-span-4 flex flex-col gap-6">
              <div class="edu-card h-full flex flex-col">
                <div class="flex items-center justify-between mb-4 pb-2 border-b" style="border-color: var(--color-outline-variant);">
                  <div>
                    <h3 class="font-headline-md" style="color: var(--color-on-background);">${todayName}'s Classes</h3>
                    <p class="font-label-sm" style="color: var(--color-on-surface-variant);">1-Click Attendance Logger</p>
                  </div>
                ...
                <div class="flex flex-col gap-3 flex-grow overflow-y-auto" style="max-height: 520px;">
                  ${todayClasses.length === 0 ? `
                    <div class="text-center py-10" style="color: var(--color-on-surface-variant);">
                      <span class="material-symbols-outlined" style="font-size: 40px;">event_available</span>
                      <p class="font-body-md mt-2">No scheduled classes for ${todayName}!</p>
